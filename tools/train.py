...
parser.add_argument('--dataset_root', type=str, default = '/project/1_2301/DPANet-master/YCB_Video_Dataset', help='dataset root dir (''YCB_Video_Dataset'' or ''Linemod_preprocessed'')')
...
parser.add_argument('--nepoch', type=int, default=101, help='max number of epochs to train')
