...
parser.add_argument('--dataset_root', type=str, default = '/project/1_2301/DPANet-master/YCB_Video_Dataset', help='dataset root dir')
parser.add_argument('--model', type=str, default = '/project/1_2301/MaskedFusion-master/trained_models/ycb/pose_model_48_0.02942494787275791.pth',  help='resume PoseNet model')
parser.add_argument('--refine_model', type=str, default = '/project/1_2301/MaskedFusion-master/trained_models/ycb/pose_refine_model_1_0.5533661097288132.pth',  help='resume PoseRefineNet model')
